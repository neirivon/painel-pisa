# scripts/importar_microdados_ed_basica_2023.py
...
ARQUIVO_CSV = os.path.expanduser("~/backup_dados_pesados/SAEB_novo/DADOS/2021_2023/2023/microdados_censo_escolar_2023/dados/microdados_ed_basica_2023.csv")
ARQUIVO_JSON = "dados_processados/saeb/microdados_ed_basica_2023.json"

NOME_BANCO = "saeb"
NOME_COLECAO = "microdados_educacao_2023"

print("📄 Lendo microdados da educação básica 2023...")
