# scripts/extrair_escalas_saeb2023_bncc.py
...
# CONFIGURAÇÃO
# =====================
PDF_PATH = "/home/neirivon/backup_dados_pesados/SAEB_novo/DADOS/2021_2023/2023/ESCALAS DE PROFICIÊNCIA/Escalas de Proficiência do Saeb - BNCC.pdf"
ANO = 2023
TIPO = "bncc"
NOME_BANCO = "saeb"
NOME_COLECAO = "saeb_escalas_2023"

JSON_OUT = "dados_processados/saeb/escalas_saeb2023_bncc.json"

# =====================
# EXTRAÇÃO DO PDF
# =====================
print("📄 Extraindo texto da escala BNCC (SAEB 2023)...")
...
registro = {
    ...
    "tipo": TIPO,
    "fonte": "INEP",
    "documento": "Escalas de Proficiência do Saeb (versão BNCC)",
