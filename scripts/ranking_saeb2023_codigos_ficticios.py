...
df_escolas = df_escolas.rename(columns={"ID_MUNICIPIO": "ID_MUNICIPIO_escola", "ID_UF": "ID_UF_escola"})
...
print("\n✅ Arquivo gerado com sucesso: ranking_saeb2023_codigos_ficticios.csv")
