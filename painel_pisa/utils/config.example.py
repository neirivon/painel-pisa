# painel_pisa/utils/config.example.py
...
# URI do MongoDB - baseada em variáveis de ambiente (nunca coloque diretamente aqui)
...
CONFIG = {
    ...
    "FAISS_INDEX_PATH": "/caminho/para/pisa.index" if MODO_EXECUCAO == "local" else None,
